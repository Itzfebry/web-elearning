...
@section('titleHeader', "Data Materi")
@section('addBtn')
<a href="{{ route('materi.create') }}" class="button blue">
    <span>Tambah</span>
</a>
@endsection
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td data-label="NIP">{{ $item->tanggal }}</td>
                            ...
                            <td class="actions-cell content-delete">
                                <div class="buttons right nowrap">
                                    ...
                                    <button type="button" class="button small red openModalBtn"
                                        data-form_id="{{ $item->id }}" data-form_name="{{ $item->judul_materi }}">
                                        <span class="icon">
        ...
        $('#modalDelete').html(`
            <div id="myModal-${formId}" style="background-color: rgba(0,0,0,0.5);" class="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
                <div class="bg-white p-6 rounded-lg w-96 shadow-lg relative">
                    ...
                    <p class="mb-4">Apakah anda ingin menhapus data materi <b>${formName}</b>?</p>
