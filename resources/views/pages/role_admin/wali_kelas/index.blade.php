...
@section('titleHeader', "Data Wali Kelas")
@section('addBtn')
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td data-label="Wali Kelas">{{ $item->guru->nama }}</td>
                            ...
                            <td class="actions-cell content-delete">
                                <div class="buttons right nowrap">
                                    ...
                                    <button type="button" class="button small red openModalBtn"
                                        data-form_id="{{ $item->id }}" data-form_name="{{ $item->guru->nama }}">
                                        <span class="icon">
        ...
        $('#modalDelete').html(`
            <div id="myModal-${formId}" class="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
                <div class="bg-white p-6 rounded-lg w-96 shadow-lg relative">
                    ...
                    <p class="mb-4">Apakah anda ingin menghapus data wali kelas <b>${formName}</b>?</p>
                    <form action="{{ route('wali-kelas.delete') }}" method="POST">
                        @csrf
